num_of_inserted_activities = 5
percentage_of_inserted_activities = 0.2
percentage_of_noises = 0.01
n_context = 3
...
#final_frame.to_csv(num_of_inserted_activities + "_inserted_activities_" + percentage_of_inserted_activities + "_" + n_context + "_" + threshold + "_result.csv", encoding='utf-8', index=False)
        final_frame.to_csv(str(num_of_inserted_activities) + "_inserted_activities_" + str(percentage_of_inserted_activities) + "_" + str(n_context) + "_" + file.split("\\")[1] + "_no_result.csv", encoding='utf-8', index=False)
        results = []